...
class BookOverview extends StatelessWidget {
  final Map item;
  const BookOverview({super.key, required this.item});
        ...
        children: [
          Stack(children: [
            ...
            Positioned(
                ...
                child: CircleAvatar(
                  ...
                  child: Icon(
                    item['favourite'] ? LineIcons.heartAlt : LineIcons.heart,
                    size: 20,
                    color: danger,
                  ),
                )),
          ...
          Container(
            ...
            child: Text(
              item['sub_title'],
              maxLines: 1,
              style: TextStyle(fontSize: 15, color: black.withOpacity(0.4)),
              overflow: TextOverflow.ellipsis,
            ),
          ),
          SizedBox(
